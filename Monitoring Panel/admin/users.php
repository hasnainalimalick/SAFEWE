...
?>
                <a href="usernew.php" class="btn-primary btn">Add New User</a>
                <br>
                <br>
                <div class="card mb-4">
...
?>
                                    ...
                                    if (mysqli_num_rows($result1) > 0) {
                                        ...
                                        <td><a href="editu.php?id=<?php echo $id;?>">Edit</a></td>
                                        <td><a href="users.php?id=<?php echo $id;?>">Delete</a></td>
