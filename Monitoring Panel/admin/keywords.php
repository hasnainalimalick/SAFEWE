...
<head>
    ...
    <title>Keywords - Block Sites</title>
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                ?>
                <a href="keynew.php" class="btn-primary btn">Add New Keyword</a>
                <br>
                <br>
                <div class="card mb-4">
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="editk.php?id=<?php echo $id;?>">Edit</a></td>
                                        <td><a href="keywords.php?id=<?php echo $id;?>">Delete</a></td>
