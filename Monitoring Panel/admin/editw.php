...
<head>
    ...
    <title>Edit Website - Block Sites</title>
        ...
        <main>
            <div class="container-fluid px-4">
                ...
                if(isset($_POST["link"])){
                    ...
                    $sql = "UPDATE websites SET link='$link', cid='$cid' WHERE id='$uid'";
                ...
                $userSql="SELECT * FROM websites WHERE id='$uid'";
                                    ...
                                    <div class="col-6 mx-auto">
                                        <form method="post" action="">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="link"  name="link" value="<?php echo $rowuser['link'];?>" placeholder="Website Link">
                                                <label for="link">Website Domain</label>
                                            </div>
