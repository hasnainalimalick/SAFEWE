...
<head>
    ...
    <title>Edit Category - Block Sites</title>
        ...
        <main>
            <div class="container-fluid px-4">
                ...
                if(isset($_POST["cname"])){
                    ...
                    $sql = "UPDATE cats SET cname='$cname' WHERE id='$cid'";
                ...
                <br>
                <?php
                $catsql="SELECT * FROM cats WHERE id='$cid'";
                            ...
                            <div class="col-6 mx-auto">
                                <form method="post" action="">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="cname" value="<?php echo $rowcat['cname'];?>"  name="cname" placeholder="Category Name">
