...
<head>
    ...
    <title>Edit User - Block Sites</title>
        ...
        <main>
            <div class="container-fluid px-4">
                ...
                if(isset($_POST["uname"])){
                    ...
                    $sql = "UPDATE users SET uname='$uname', upass='$upass', cid='$cid' WHERE id='$uid'";
...
$userSql="SELECT * FROM users WHERE id='$uid'";
                            ...
                            <div class="col-6 mx-auto">
                                <form method="post" action="">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="uname"  name="uname" value="<?php echo $rowuser['uname'];?>" placeholder="User Name">
                                        <label for="uname">UserName</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="upass" name="upass" value="<?php echo $rowuser['upass'];?>" type="password" placeholder="Password">
