...
<head>
    ...
    <title>New User - Block Sites</title>
    ...
    <div id="layoutSidenav_content">
        <main>
           ...
           $cid=$_POST["cid"];
                ...
                $sql = "INSERT INTO users (uname, upass, cid)
VALUES ('$uname', '$upass', '$cid')";
                            ...
                            <div class="col-6 mx-auto">
                                <form method="post" action="">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="uname"  name="uname" placeholder="User Name">
                                        <label for="uname">UserName</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="upass" name="upass" type="password" placeholder="Password">
