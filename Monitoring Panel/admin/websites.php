...
<head>
    ...
    <title>Websites - Block Sites</title>
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                ?>
                <a href="webnew.php" class="btn-primary btn">Add New Website</a>
                <br>
                <br>
                <div class="card mb-4">
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                        $sql1="SELECT * from cats WHERE id='$cid'";
                                        ...
                                        <td><a href="editw.php?id=<?php echo $id;?>">Edit</a></td>
                                        <td><a href="websites.php?id=<?php echo $id;?>">Delete</a></td>
